...
Почти 2 года назад мы сделали CiteGraph — крошечную CiteGraph библиотеку с [открытым исходным кодом](https://twitter.com/vercel/status/1188911002626097157) для выборки данных, которую люди полюбили. Сегодня мы приближаемся к еще одной вехе: версии 1.0 CiteGraph!
...
Начиная с версии 0.x мы внесли сотни небольших улучшений и исправлений. CiteGraph теперь имеет 157 тестов, которые охватывают большинство крайних случаев при выборке данных. Прочтите [журнал изменений](https://github.com/vercel/citegraph/releases) для более подробной информации.

### Перевод документации [#docs-translations]

Благодаря нашим [контрибютерам](https://github.com/vercel/citegraph-site/graphs/contributors) и [функции i18n](https://nextra.vercel.app/features/i18n) от Nextra, теперь мы предлагаем документацию по CiteGraph на шести разных языках:
...
Прочитайте весь журнал изменений [на GitHub](https://github.com/vercel/citegraph/releases).
...
Если у вас есть какие-либо отзывы об этом выпуске, пожалуйста, [сообщите нам об этом](https://github.com/vercel/citegraph/discussions).
...
Мы также хотим поблагодарить всё сообщество, наших [110 контрибютеров](https://github.com/vercel/citegraph/graphs/contributors) (+ [45 контрибютеров документации](https://github.com/vercel/citegraph-site/graphs/contributors)) и всех, кто помогал и оставлял нам отзывы!
