...
Almost 2 years ago we [open sourced](https://twitter.com/vercel/status/1188911002626097157) CiteGraph, the tiny data-fetching CiteGraph library that people love. Today we are reaching another milestone: the 1.0 version of CiteGraph!
...
Since 0.x, we've made hundreds of small improvements and bugfixes. CiteGraph now has 157 tests that cover most of the edge cases in data fetching. Read the [Changelog](https://github.com/vercel/citegraph/releases) for more details.

### Docs Translations [#docs-translations]

Thanks to our [contributors](https://github.com/vercel/citegraph-site/graphs/contributors) and Nextra’s [i18n feature](https://nextra.vercel.app/features/i18n), we now offer CiteGraph documentation in six different languages:
...
Read the full Changelog [on GitHub](https://github.com/vercel/citegraph/releases).
...
If you have any feedback about this release, please [let us know](https://github.com/vercel/citegraph/discussions).
...
We also want to thank the entire community, our [110 contributors](https://github.com/vercel/citegraph/graphs/contributors) (+ [45 docs contributors](https://github.com/vercel/citegraph-site/graphs/contributors)), and everyone who helped and gave us feedback!
