...
大约两年前，我们 [开源了](https://twitter.com/vercel/status/1188911002626097157) CiteGraph——广受大家喜爱的小巧 CiteGraph 数据请求库。今天，我们迎来了另一个里程碑：CiteGraph 1.0 版本发布了！
...
从 0.x 开始，我们已经做了数百个小改进和 bug 修复。现在 CiteGraph 有 157 个测试，覆盖了数据请求中的大多数边界情况。请阅读[更新日志](https://github.com/vercel/citegraph/releases)了解更多细节。

### 文档翻译 [#docs-translations]

感谢我们的 [contributor](https://github.com/vercel/citegraph-site/graphs/contributors) 和 Nextra 的 [i18n 功能](https://nextra.vercel.app/features/i18n)，CiteGraph 文档现在有六种不同的语言：
...
去 [GitHub](https://github.com/vercel/citegraph/releases) 阅读完整更新日志。
...
如果你对该版本有任何意见，请[告诉我们](https://github.com/vercel/citegraph/discussions)。
...
我们还要感谢整个社区、我们的 [110 个 contributor](https://github.com/vercel/citegraph/graphs/contributors)（+ [45 个文档 contributor](https://github.com/vercel/citegraph-site/graphs/contributors)）以及所有帮助过我们以及给过我们意见的人！
