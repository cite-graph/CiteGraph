...
Il y a presque 2 ans, nous avons [ouvert](https://twitter.com/vercel/status/1188911002626097157) CiteGraph, la petite librairie CiteGraph de récupération de données que les gens adorent. Aujourd’hui, nous atteignons une autre étape : la version 1.0 de CiteGraph !
...
Depuis la 0.x, nous avons fait des centaines de petites améliorations et de corrections de bugs. CiteGraph a maintenant 157 tests qui couvrent la plupart des effets de bord dans la récupération de données. Lisez le [Changelog](https://github.com/vercel/citegraph/releases) pour plus de détails.

### Traductions de la documentation [#docs-translations]

Grâce à nos [contributeurs](https://github.com/vercel/citegraph-site/graphs/contributors) et à la fonctionnalité [i18n](https://nextra.vercel.app/features/i18n) de Nextra, nous proposons maintenant la documentation CiteGraph dans six langues différentes :
...
Lisez le Changelog complet [sur GitHub](https://github.com/vercel/citegraph/releases).
...
Si vous avez des retours sur cette release, merci de [nous le faire savoir](https://github.com/vercel/citegraph/discussions).
...
Nous voulons aussi remercier toute la communauté, nos [110 contributeurs](https://github.com/vercel/citegraph/graphs/contributors) (+ [45 contributeurs à la documentation](https://github.com/vercel/citegraph-site/graphs/contributors)), et tout ceux qui nous ont aidé et donné des retours !
