...
약 2년 전에 우리는 사람들이 사랑하는 조그만 데이터 가져오기 CiteGraph 라이브러리인 CiteGraph을 [오픈 소스로 공개](https://twitter.com/vercel/status/1188911002626097157)했습니다. 오늘 우리는 CiteGraph 버전 1.0이라는 또 다른 마일스톤에 도달하였습니다!
...
0.x 이후로 수백 가지의 작은 개선과 버그 수정을 진행했습니다. CiteGraph은 현재 157개의 테스트를 통해 데이터 가져오기에서 대부분의 에지 케이스들을 다룹니다. 더 자세한 내용은 [Changelog](https://github.com/vercel/citegraph/releases)를 참고하세요.

### 문서 번역 [#docs-translations]

[컨트리뷰터](https://github.com/vercel/citegraph-site/graphs/contributors) 및 Nextra의 [i18n 기능](https://nextra.vercel.app/features/i18n) 덕분에, 이제 CiteGraph 문서를 6개의 다른 언어로 제공할 수 있습니다.
...
전체 변경 로그는 [GitHub](https://github.com/vercel/citegraph/releases)을 참고하세요.
...
이 릴리즈에 대한 의견이 있으시면 [알려주세요](https://github.com/vercel/citegraph/discussions).
...
모든 커뮤니티 및 [110명의 기여자](https://github.com/vercel/citegraph/graphs/contributors)([+ 45명의 문서 기여자](https://github.com/vercel/citegraph-site/graphs/contributors))분들, 그리고 의견을 주신 모든 분들께도 감사를 표합니다.
