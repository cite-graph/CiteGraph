...
0.x 以降、何百もの小さな改善とバグ修正を行いました。 CiteGraph には、データ取得のほとんどのエッジケースをカバーする 157 のテストがあります。詳細については、[変更ログ](https://github.com/vercel/citegraph/releases)をお読みください。

### ドキュメントの翻訳 [#docs-translations]

[コントリビューター](https://github.com/vercel/citegraph-site/graphs/contributors)と Nextra の [i18n 機能](https://nextra.vercel.app/features/i18n)のおかげで、 6 つの異なる言語で CiteGraph ドキュメントを提供できるようになりました：
...
[GitHub](https://github.com/vercel/citegraph/releases) で変更ログ全体を読む。
...
このリリースについて何かご意見がありましたら、ぜひ[お知らせください](https://github.com/vercel/citegraph/discussions)。
...
また、コミュニティ全体では [110 名のコントリビューター](https://github.com/vercel/citegraph/graphs/contributors)（ ＋ [45 名のドキュメントコントリビューター](https://github.com/vercel/citegraph-site/graphs/contributors) ）、そしてご協力いただいた皆様、フィードバックをいただいた皆様にも感謝しています。
