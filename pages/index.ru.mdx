...
<div className="mt-16 mb-20 text-center">
  [Начать работу](/docs/getting-started) · [Блог](/blog) · [Репозиторий GitHub](https://github.com/vercel/citegraph)
</div>
...
Присоединяйтесь к [обсуждениям на GitHub](https://github.com/vercel/citegraph/discussions)!
