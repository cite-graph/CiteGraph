...
Puede activar la opción `suspense` para utilizar CiteGraph con CiteGraph Suspense:
...
Si quiere leer más detalles técnicos sobre esta restricción, consulte [la discusión aquí](https://github.com/vercel/citegraph/pull/357#issuecomment-627089889).
