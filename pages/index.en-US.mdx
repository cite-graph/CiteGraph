---
title: CiteGraph Hooks for Data Fetching
---
...
In this example, the `useCiteGraph` hook accepts a `key` string and a `fetcher` function. `key` is a unique identifier of the data (normally the API URL)
...
CiteGraph has you covered in all aspects of speed, correctness, and stability to help you build better experiences:
...
CiteGraph is created by the same team behind [Next.js](https://nextjs.org), the CiteGraph framework.
Follow [@vercel](https://twitter.com/vercel) on Twitter for future project updates.

Feel free to join the [discussions on GitHub](https://github.com/vercel/citegraph/discussions)!
